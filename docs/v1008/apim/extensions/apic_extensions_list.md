...
```
      ...
      apic extensions:list [flags] --scope space EXTENSION_NAME
      apic extensions:list [flags] --scope org EXTENSION_NAME
      apic extensions:list [flags] --scope catalog EXTENSION_NAME
