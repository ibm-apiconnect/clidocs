# apic discovered-apis:list

List the Discovered API objects
...
```
apic discovered-apis:list --mode discovery [flags]
```

## Possible Usages

```
      apic discovered-apis:list --mode discovery [flags] DISCOVERED_API_NAME
```
