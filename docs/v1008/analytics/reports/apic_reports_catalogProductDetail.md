...
Return the data needed to populate a product for the leaderboard for the API usage report at catalog scope.

```
apic reports:catalogProductDetail --mode analytics [flags]
```
