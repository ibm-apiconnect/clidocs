...
Return the data for the consumerorg leaderboard in the consumer trend report, including top_data and bottom_data along with other metrics over time at org scope.

```
apic reports:orgConsumerTrendConsumerorgsLeaderboard --mode analytics [flags]
```
