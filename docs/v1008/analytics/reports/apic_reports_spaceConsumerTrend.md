...
Return the data needed to populate the consumer trend report, including trends and data of consumers, applications, and subscriptions, at space scope.

```
apic reports:spaceConsumerTrend --mode analytics [flags]
```
