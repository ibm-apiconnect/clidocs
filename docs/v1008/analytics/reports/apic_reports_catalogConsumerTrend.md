...
Return the data needed to populate the consumer trend report, including trends and data of consumers, applications, and subscriptions, at the catalog scope.

```
apic reports:catalogConsumerTrend --mode analytics [flags]
```
