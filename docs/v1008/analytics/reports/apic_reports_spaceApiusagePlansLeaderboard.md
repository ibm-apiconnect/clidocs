...
Return the data needed to populate the plan leaderboard for the API usage report at space scope.

```
apic reports:spaceApiusagePlansLeaderboard --mode analytics [flags]
```
