# apic dashboards:spaceSummary

Get the data needed to populate the SUMMARY dashboard at space scope

## Synopsis

Return the data needed to populate the SUMMARY dashboard at space scope.

```
apic dashboards:spaceSummary --mode analytics [flags]
```
