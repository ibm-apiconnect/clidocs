# apic reports:spaceApiusageApisLeaderboard

API usage report API leaderboard (space)

## Synopsis

Return the data needed to populate the API leaderboard for the API usage report at space scope.

```
apic reports:spaceApiusageApisLeaderboard --mode analytics [flags]
```
