# apic clustermgmt:postAliasByIndexAlias
...
```
apic clustermgmt:postAliasByIndexAlias --mode analytics [flags]
```

## Possible Usages

```
      apic clustermgmt:postAliasByIndexAlias --mode analytics [flags] ALIAS_BODY_FILE
```
