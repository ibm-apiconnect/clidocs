# apic reports:orgApiusageProductsLeaderboard

API usage report product leaderboard (org)

## Synopsis

Return the data needed to populate the product leaderboard for the API usage report at org scope.

```
apic reports:orgApiusageProductsLeaderboard --mode analytics [flags]
```
