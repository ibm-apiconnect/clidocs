# apic reports:orgApiusagePlansLeaderboard

API usage report plan leaderboard (org)

## Synopsis

Return the data needed to populate the plan leaderboard for the API usage report at org scope.

```
apic reports:orgApiusagePlansLeaderboard --mode analytics [flags]
```
