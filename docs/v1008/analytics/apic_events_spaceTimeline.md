# apic events:spaceTimeline

Get the data needed to populate the Timeline chart in discover view at space scope

## Synopsis

Return the data needed to populate the Timeline chart in discover view at space scope.
