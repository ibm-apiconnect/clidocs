# apic reports:spaceProductsLeaderboard

Product leaderboard (space)

## Synopsis

Return the data needed to populate the Product leaderboard at space scope.

```
apic reports:spaceProductsLeaderboard --mode analytics [flags]
```
