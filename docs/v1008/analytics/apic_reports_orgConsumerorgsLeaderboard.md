# apic reports:orgConsumerorgsLeaderboard

Consumer organization leaderboard (org)

## Synopsis

Return the data needed to populate the Consumer Organization leaderboard at org scope.

```
apic reports:orgConsumerorgsLeaderboard --mode analytics [flags]
```
