...
Return the data needed to populate the API leaderboard for the API usage report at catalog scope.

```
apic reports:catalogApiusageApisLeaderboard --mode analytics [flags]
```
