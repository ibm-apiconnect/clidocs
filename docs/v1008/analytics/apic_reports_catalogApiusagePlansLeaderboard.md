# apic reports:catalogApiusagePlansLeaderboard

API usage report plan leaderboard (catalog)

## Synopsis

Return the data needed to populate the plan leaderboard for the API usage report at catalog scope.

```
apic reports:catalogApiusagePlansLeaderboard --mode analytics [flags]
```
