# apic reports:cloudApiusageApisLeaderboard

API usage report API leaderboard (cloud)

## Synopsis

Return the data needed to populate the API leaderboard for the API usage report at cloud scope.

```
apic reports:cloudApiusageApisLeaderboard --mode analytics [flags]
```
