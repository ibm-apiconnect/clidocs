# apic reports:spaceApisLeaderboard

API leaderboard (space)

## Synopsis

Return the data needed to populate the API leaderboard at space scope.

```
apic reports:spaceApisLeaderboard --mode analytics [flags]
```
