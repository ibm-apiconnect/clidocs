# apic reports:cloudApiusagePlansLeaderboard

API usage report plan leaderboard (cloud)

## Synopsis

Return the data needed to populate the plan leaderboard for the API usage report at cloud scope.

```
apic reports:cloudApiusagePlansLeaderboard --mode analytics [flags]
```
