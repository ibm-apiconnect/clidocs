# apic reports:spaceConsumerTrendConsumerorgsLeaderboard

Consumer trend report consumer org leaderboard (space)

## Synopsis

Return the data for the consumerorg leaderboard in the consumer trend report, including top_data and bottom_data along with other metrics over time at the space scope.
