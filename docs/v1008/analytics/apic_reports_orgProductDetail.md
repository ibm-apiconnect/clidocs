# apic reports:orgProductDetail

Product detail report (org)

## Synopsis

Return the data needed to populate a product for the leaderboard for the API usage report at org scope.
