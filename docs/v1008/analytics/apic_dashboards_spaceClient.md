# apic dashboards:spaceClient

Get the data needed to populate the Client dashboard at space scope

## Synopsis

Return the data needed to populate the Client dashboard at space scope.

```
apic dashboards:spaceClient --mode analytics [flags]
```
