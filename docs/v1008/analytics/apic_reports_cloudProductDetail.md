# apic reports:cloudProductDetail

Product detail report (cloud)

## Synopsis

Return the data needed to populate a product for the leaderboard for the API usage report at cloud scope.

```
apic reports:cloudProductDetail --mode analytics [flags]
```
...
```
      ...
      --productref string          Product reference (name:version) (required)
