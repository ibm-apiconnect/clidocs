...
- "scope: space"
---
# apic dashboards:spaceApplication

Get the data needed to populate the Application dashboard at space scope

## Synopsis

Return the data needed to populate the Application dashboard at space scope.

```
apic dashboards:spaceApplication --mode analytics [flags]
```
