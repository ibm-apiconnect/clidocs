# apic reports:orgDeprecatedProduct

Deprecated product report table (org)

## Synopsis

Return the data needed to populate the Deprecated product report table at org scope

```
apic reports:orgDeprecatedProduct --mode analytics [flags]
```
