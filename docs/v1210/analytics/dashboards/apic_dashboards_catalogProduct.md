...
- "scope: catalog"
---
# apic dashboards:catalogProduct

Get the data needed to populate the Product dashboard at catalog scope

## Synopsis

Return the data needed to populate the Product dashboard at catalog scope.

```
apic dashboards:catalogProduct --mode analytics [flags]
```
