...
- "scope: catalog"
---
# apic dashboards:catalogConsumer

Get the data needed to populate the Consumer dashboard at catalog scope

## Synopsis

Return the data needed to populate the Consumer dashboard at catalog scope.

```
apic dashboards:catalogConsumer --mode analytics [flags]
```
