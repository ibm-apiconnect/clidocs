...
- "scope: cloud"
---
# apic dashboards:cloudAi

Get the data needed to populate the AI dashboard at cloud scope

## Synopsis

Return the data needed to populate the AI dashboard at cloud scope.
