...
- "scope: org"
---
# apic dashboards:orgGateway

Get the data needed to populate the Gateway Operations dashboard at provider organization scope

## Synopsis

Return the data needed to populate the Gateway Operations dashboard at provider organization scope.
