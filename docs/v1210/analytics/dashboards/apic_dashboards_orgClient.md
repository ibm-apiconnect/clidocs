...
- "scope: org"
---
# apic dashboards:orgClient

Get the data needed to populate the Client dashboard at provider organization scope

## Synopsis

Return the data needed to populate the Client dashboard at provider organization scope.

```
apic dashboards:orgClient --mode analytics [flags]
```
