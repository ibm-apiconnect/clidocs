...
- "scope: cloud"
---
# apic dashboards:cloudClientWorldmap

Get the data needed to populate the worldmap dashboard at cloud scope

## Synopsis

Return the data needed to populate the worldmap dashboard at cloud scope.

```
apic dashboards:cloudClientWorldmap --mode analytics [flags]
```
