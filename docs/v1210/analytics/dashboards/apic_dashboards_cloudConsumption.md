...
- "scope: cloud"
---
# apic dashboards:cloudConsumption

Get the data needed to populate the Consumption dashboard at cloud scope

## Synopsis

Return the data needed to populate the Consumption dashboard at cloud scope.
