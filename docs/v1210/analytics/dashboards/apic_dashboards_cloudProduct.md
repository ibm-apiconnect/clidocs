...
- "scope: cloud"
---
# apic dashboards:cloudProduct

Get the data needed to populate the Product dashboard at cloud scope

## Synopsis

Return the data needed to populate the Product dashboard at cloud scope.

```
apic dashboards:cloudProduct --mode analytics [flags]
```
