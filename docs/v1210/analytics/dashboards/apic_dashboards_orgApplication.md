...
- "scope: org"
---
# apic dashboards:orgApplication

Get the data needed to populate the Application dashboard at provider organization scope

## Synopsis

Return the data needed to populate the Application dashboard at provider organization scope.

```
apic dashboards:orgApplication --mode analytics [flags]
```
