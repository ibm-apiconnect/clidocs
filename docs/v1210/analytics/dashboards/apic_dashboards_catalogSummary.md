...
- "scope: catalog"
---
# apic dashboards:catalogSummary

Get the data needed to populate the SUMMARY dashboard at catalog scope

## Synopsis

Return the data needed to populate the SUMMARY dashboard at catalog scope.

```
apic dashboards:catalogSummary --mode analytics [flags]
```
