...
- "scope: cloud"
---
# apic dashboards:cloudClient

Get the data needed to populate the Client dashboard at cloud scope

## Synopsis

Return the data needed to populate the Client dashboard at cloud scope.
