...
- "scope: cloud"
---
# apic dashboards:cloudData

Get the data needed to populate the Data dashboard at cloud scope

## Synopsis

Return the data needed to populate the Data dashboard at cloud scope.
