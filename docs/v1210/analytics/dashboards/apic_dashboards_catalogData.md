...
- "scope: catalog"
---
# apic dashboards:catalogData

Get the data needed to populate the Data dashboard at catalog scope

## Synopsis

Return the data needed to populate the Data dashboard at catalog scope.

```
apic dashboards:catalogData --mode analytics [flags]
```
