...
- "scope: cloud"
---
# apic dashboards:cloudApplication

Get the data needed to populate the Application dashboard at cloud scope

## Synopsis

Return the data needed to populate the Application dashboard at cloud scope.

```
apic dashboards:cloudApplication --mode analytics [flags]
```
