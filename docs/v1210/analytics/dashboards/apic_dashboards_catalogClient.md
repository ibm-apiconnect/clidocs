...
- "scope: catalog"
---
# apic dashboards:catalogClient

Get the data needed to populate the Client dashboard at catalog scope

## Synopsis

Return the data needed to populate the Client dashboard at catalog scope.
