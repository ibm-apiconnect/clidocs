...
- "scope: catalog"
---
# apic dashboards:catalogClientWorldmap

Get the data needed to populate the worldmap at client dashboard at catalog scope

## Synopsis

Return the data needed to populate the worldmap at client dashboard at catalog scope.

```
apic dashboards:catalogClientWorldmap --mode analytics [flags]
```
