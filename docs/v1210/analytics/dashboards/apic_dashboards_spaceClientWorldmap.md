...
- "scope: space"
---
# apic dashboards:spaceClientWorldmap

Get the data needed to populate the worldmap at client dashboard at space scope

## Synopsis

Return the data needed to populate the worldmap at client dashboard at space scope.

```
apic dashboards:spaceClientWorldmap --mode analytics [flags]
```
