...
- "scope: org"
---
# apic dashboards:orgData

Get the data needed to populate the Data dashboard at provider organization scope

## Synopsis

Return the data needed to populate the Data dashboard at provider organization scope.
