...
- "scope: org"
---
# apic dashboards:orgSummary

Get the data needed to populate the SUMMARY dashboard at provider organization scope

## Synopsis

Return the data needed to populate the SUMMARY dashboard at provider organization scope.

```
apic dashboards:orgSummary --mode analytics [flags]
```
