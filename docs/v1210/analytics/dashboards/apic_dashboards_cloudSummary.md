...
- "scope: cloud"
---
# apic dashboards:cloudSummary

Get the data needed to populate the SUMMARY dashboard at cloud scope

## Synopsis

Return the data needed to populate the SUMMARY dashboard at cloud scope.
