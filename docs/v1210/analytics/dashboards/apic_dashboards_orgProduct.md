...
- "scope: org"
---
# apic dashboards:orgProduct

Get the data needed to populate the Product dashboard at provider organization scope

## Synopsis

Return the data needed to populate the Product dashboard at provider organization scope.
