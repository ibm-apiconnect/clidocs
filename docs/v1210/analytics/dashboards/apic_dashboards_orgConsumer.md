...
- "scope: org"
---
# apic dashboards:orgConsumer

Get the data needed to populate the Consumer dashboard at provider organization scope

## Synopsis

Return the data needed to populate the Consumer dashboard at provider organization scope.
