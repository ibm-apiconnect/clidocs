...
- "scope: org"
---
# apic dashboards:orgApi

Get the data needed to populate the API dashboard at provider organization scope

## Synopsis

Return the data needed to populate the API dashboard at provider organization scope.

```
apic dashboards:orgApi --mode analytics [flags]
```
