...
- "scope: org"
---
# apic dashboards:orgLatency

Get the data needed to populate the Latency dashboard at provider organization scope

## Synopsis

Return the data needed to populate the Latency dashboard at provider organization scope.
