...
- "scope: catalog"
---
# apic dashboards:catalogApi

Get the data needed to populate the API dashboard at catalog scope

## Synopsis

Return the data needed to populate the API dashboard at catalog scope.

```
apic dashboards:catalogApi --mode analytics [flags]
```
