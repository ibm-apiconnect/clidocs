...
- "scope: cloud"
---
# apic dashboards:cloudConsumer

Get the data needed to populate the Consumer dashboard at cloud scope

## Synopsis

Return the data needed to populate the Consumer dashboard at cloud scope.

```
apic dashboards:cloudConsumer --mode analytics [flags]
```
