...
- "scope: org"
---
# apic dashboards:orgClientWorldmap

Get the data needed to populate the worldmap at client dashboard at provider organization scope

## Synopsis

Return the data needed to populate the worldmap at client dashboard at provider organization scope.

```
apic dashboards:orgClientWorldmap --mode analytics [flags]
```
...
```
      ...
      --bottom_right string                      The latitude and longitude of the bottom right corner of the chart.
      ...
      --catalog_id string                        Filter results by for audit catalog ID.
  ...
  -s, --server string                            management server endpoint (required)
      --space_id string                          Filter result by space Id
      ...
      --top_left string                          The latitude and longitude of the  top left corner of the chart.
      ...
      --zoom string                              Zoom level of the map
```
