...
- "scope: org"
---
# apic dashboards:orgConsumption

Get the data needed to populate the Consumption dashboard at provider organization scope

## Synopsis

Return the data needed to populate the Consumption dashboard at provider organization scope.

```
apic dashboards:orgConsumption --mode analytics [flags]
```
