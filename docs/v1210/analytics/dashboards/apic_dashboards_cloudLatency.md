...
- "scope: cloud"
---
# apic dashboards:cloudLatency

Get the data needed to populate the Latency dashboard at cloud scope

## Synopsis

Return the data needed to populate the Latency dashboard at cloud scope.
