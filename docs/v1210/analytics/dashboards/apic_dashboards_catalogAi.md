...
- "scope: catalog"
---
# apic dashboards:catalogAi

Get the data needed to populate the AI dashboard at catalog scope

## Synopsis

Return the data needed to populate the AI dashboard at catalog scope.
