...
- "scope: catalog"
---
# apic dashboards:catalogApplication

Get the data needed to populate the Application dashboard at catalog scope

## Synopsis

Return the data needed to populate the Application dashboard at catalog scope.

```
apic dashboards:catalogApplication --mode analytics [flags]
```
