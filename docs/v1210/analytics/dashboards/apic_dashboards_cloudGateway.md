...
- "scope: cloud"
---
# apic dashboards:cloudGateway

Get the data needed to populate the Gateway Operations dashboard at cloud scope

## Synopsis

Return the data needed to populate the Gateway Operations dashboard at cloud scope.
