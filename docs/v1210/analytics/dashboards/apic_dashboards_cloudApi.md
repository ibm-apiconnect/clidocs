...
- "scope: cloud"
---
# apic dashboards:cloudApi

Get the data needed to populate the API dashboard at cloud scope

## Synopsis

Return the data needed to populate the API dashboard at cloud scope.

```
apic dashboards:cloudApi --mode analytics [flags]
```
