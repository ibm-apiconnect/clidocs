...
- "scope: org"
---
# apic dashboards:orgAi

Get the data needed to populate the AI dashboard at provider organization scope

## Synopsis

Return the data needed to populate the AI dashboard at provider organization scope.
