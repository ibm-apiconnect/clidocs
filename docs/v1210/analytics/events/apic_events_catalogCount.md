...
- "scope: catalog"
---
# apic events:catalogCount

Count events at catalog scope

## Synopsis

Return the count of analytics API events scoped to the catalog that match the passed in request query.
