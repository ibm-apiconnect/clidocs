...
- "scope: org"
---
# apic events:orgTimeline

Get the data needed to populate the Timeline chart in discover view at org scope

## Synopsis

Return the data needed to populate the Timeline chart in discover view at org scope.
