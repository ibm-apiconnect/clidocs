...
- "scope: cloud"
---
# apic events:cloudTimeline

Get the data needed to populate the Timeline chart in discover view at cloud scope

## Synopsis

Return the data needed to populate the Timeline chart in discover view at cloud scope.
