...
- "scope: catalog"
---
# apic events:catalogTimeline

Get the data needed to populate the Timeline chart in discover view at catalog scope

## Synopsis

Return the data needed to populate the Timeline chart in discover view at catalog scope.
