...
- "scope: catalog"
---
# apic queries:catalogListCurrentDefault

List current default query at catalog scope

## Synopsis

Return the current default query shared by others at catalog scope.

```
apic queries:catalogListCurrentDefault --mode analytics [flags]
```
