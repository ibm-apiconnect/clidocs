...
- "scope: org"
---
# apic queries:orgListCurrentDefault

List current default query at org scope

## Synopsis

Return the current default query shared by others at org scope.

```
apic queries:orgListCurrentDefault --mode analytics [flags]
```
