# apic queries:spaceListShared

List shared queries at space scope.

## Synopsis

Return a list of saved queries shared by others at space scope.
...
```
  ...
  -h, --help                       Help for queries:spaceListShared
