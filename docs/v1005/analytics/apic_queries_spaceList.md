# apic queries:spaceList

List saved queries at space scope.

## Synopsis

List saved queries owned by the user making the request, at space scope.
...
```
  ...
  -h, --help                       Help for queries:spaceList
