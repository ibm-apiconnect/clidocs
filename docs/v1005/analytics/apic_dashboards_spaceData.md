# apic dashboards:spaceData

Get the data needed to populate the Data dashboard at space scope.

## Synopsis

Return the data needed to populate the Data dashboard at space scope.

```
apic dashboards:spaceData --mode analytics [flags]
```
...
```
  ...
  -h, --help                                     Help for dashboards:spaceData
