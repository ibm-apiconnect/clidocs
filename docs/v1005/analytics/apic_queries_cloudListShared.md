# apic queries:cloudListShared

List shared queries at cloud scope.

## Synopsis

Return a list of saved queries shared by others at cloud scope.
...
```
  ...
  -h, --help                       Help for queries:cloudListShared
