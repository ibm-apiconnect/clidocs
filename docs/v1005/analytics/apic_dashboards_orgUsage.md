# apic dashboards:orgUsage

Get the data needed to populate the Usage dashboard at provider organization scope.

## Synopsis

Return the data needed to populate the Usage dashboard at provider organization scope.

```
apic dashboards:orgUsage --mode analytics [flags]
```
...
```
  ...
  -h, --help                                     Help for dashboards:orgUsage
