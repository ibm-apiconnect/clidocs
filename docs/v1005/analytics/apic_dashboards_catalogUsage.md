# apic dashboards:catalogUsage

Get the data needed to populate the Usage dashboard at catalog scope.

## Synopsis

Return the data needed to populate the Usage dashboard at catalog scope.

```
apic dashboards:catalogUsage --mode analytics [flags]
```
...
```
  ...
  -h, --help                                     Help for dashboards:catalogUsage
