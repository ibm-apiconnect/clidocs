# apic dashboards:spaceLatency

Get the data needed to populate the Latency dashboard at space scope.

## Synopsis

Return the data needed to populate the Latency dashboard at space scope.

```
apic dashboards:spaceLatency --mode analytics [flags]
```
...
```
  ...
  -h, --help                                     Help for dashboards:spaceLatency
