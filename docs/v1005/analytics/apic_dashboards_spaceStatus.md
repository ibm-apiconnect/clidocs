# apic dashboards:spaceStatus

Get the data needed to populate the Status dashboard at space scope.

## Synopsis

Return the data needed to populate the Status dashboard at space scope.
...
```
  ...
  -h, --help                                     Help for dashboards:spaceStatus
