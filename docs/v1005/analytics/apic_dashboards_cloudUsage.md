# apic dashboards:cloudUsage

Get the data needed to populate the Usage dashboard at cloud scope.

## Synopsis

Return the data needed to populate the Usage dashboard at cloud scope.

```
apic dashboards:cloudUsage --mode analytics [flags]
```
...
```
  ...
  -h, --help                                     Help for dashboards:cloudUsage
