# apic dashboards:spaceConsumption

Get the data needed to populate the Consumption dashboard at space scope.

## Synopsis

Return the data needed to populate the Consumption dashboard at space scope.
...
```
  ...
  -h, --help                                     Help for dashboards:spaceConsumption
