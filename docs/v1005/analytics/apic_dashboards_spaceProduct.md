# apic dashboards:spaceProduct

Get the data needed to populate the Product dashboard at space scope.

## Synopsis

Return the data needed to populate the Product dashboard at space scope.
...
```
  ...
  -h, --help                                     Help for dashboards:spaceProduct
