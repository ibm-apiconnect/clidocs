# apic dashboards:spaceUsage

Get the data needed to populate the Usage dashboard at space scope.

## Synopsis

Return the data needed to populate the Usage dashboard at space scope.

```
apic dashboards:spaceUsage --mode analytics [flags]
```
...
```
  ...
  -h, --help                                     Help for dashboards:spaceUsage
