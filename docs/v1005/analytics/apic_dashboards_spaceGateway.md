# apic dashboards:spaceGateway

Get the data needed to populate the Gateway Operations dashboard at space scope.

## Synopsis

Return the data needed to populate the Gateway Operations dashboard at space scope.
...
```
  ...
  -h, --help                                     Help for dashboards:spaceGateway
