# apic dashboards:spaceApi

Get the data needed to populate the API dashboard at space scope.

## Synopsis

Return the data needed to populate the API dashboard at space scope.

```
apic dashboards:spaceApi --mode analytics [flags]
```
...
```
  ...
  -h, --help                                     Help for dashboards:spaceApi
