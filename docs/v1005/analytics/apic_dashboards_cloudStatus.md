# apic dashboards:cloudStatus

Get the data needed to populate the Status dashboard at cloud scope.

## Synopsis

Return the data needed to populate the Status dashboard at cloud scope.
...
```
  ...
  -h, --help                                     Help for dashboards:cloudStatus
