# apic dashboards:catalogStatus

Get the data needed to populate the Status dashboard at catalog scope.

## Synopsis

Return the data needed to populate the Status dashboard at catalog scope.
...
```
  ...
  -c, --catalog string                           Catalog name or ID. (required)
      ...
      --error_limit string                       If set, the number of items to return when requesting errors data.

      --error_offset string                      If set, the offset to be applied when requesting errors data.
  ...
  -h, --help                                     Help for dashboards:catalogStatus
