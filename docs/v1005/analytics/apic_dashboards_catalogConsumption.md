# apic dashboards:catalogConsumption

Get the data needed to populate the Consumption dashboard at catalog scope.

## Synopsis

Return the data needed to populate the Consumption dashboard at catalog scope.
...
```
  ...
  -h, --help                                     Help for dashboards:catalogConsumption
