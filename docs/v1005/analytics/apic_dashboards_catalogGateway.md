# apic dashboards:catalogGateway

Get the data needed to populate the Gateway Operations dashboard at catalog scope.

## Synopsis

Return the data needed to populate the Gateway Operations dashboard at catalog scope.

```
apic dashboards:catalogGateway --mode analytics [flags]
```
...
```
  ...
  -h, --help                                     Help for dashboards:catalogGateway
