...
[https://www.ibm.com/docs/en/api-connect/10.0.8_lts?topic=tool-logging-in-management-server](https://www.ibm.com/docs/en/api-connect/10.0.8_lts?topic=tool-logging-in-management-server)
...
To determine the identity provider, see [How to determine the identity provider](https://www.ibm.com/docs/en/api-connect/10.0.8_lts?topic=tool-logging-in-management-server#rapic_cli_login__determine_idp).
...
[https://www.ibm.com/docs/en/api-connect/10.0.8_lts?topic=tool-logging-in-management-server-oidc-registry](https://www.ibm.com/docs/en/api-connect/10.0.8_lts?topic=tool-logging-in-management-server-oidc-registry)
