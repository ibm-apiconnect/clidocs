...
Official installation instructions: [https://www.ibm.com/docs/en/api-connect/10.0.8_lts?topic=configuration-installing-toolkit](https://www.ibm.com/docs/en/api-connect/10.0.8_lts?topic=configuration-installing-toolkit)
