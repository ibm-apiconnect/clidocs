...
- "scope: org"
---
# apic destinations:orgList

List destinations at provider organization scope

## Synopsis

Return a result set of engagement destinations.

```
apic destinations:orgList --mode engagement [flags]
```
