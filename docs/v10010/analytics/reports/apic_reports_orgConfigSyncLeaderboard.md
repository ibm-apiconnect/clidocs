...
- "scope: org"
---
# apic reports:orgConfigSyncLeaderboard

Config sync leaderboard

## Synopsis

Return the data needed to populate the config sync leaderboard at org scope.

```
apic reports:orgConfigSyncLeaderboard --mode analytics [flags]
```
