...
- "scope: cloud"
---
# apic reports:cloudGatewayServicesLeaderboard

Gateway services leaderboard

## Synopsis

Return the data needed to populate the gateway services leaderboard at cloud scope.

```
apic reports:cloudGatewayServicesLeaderboard --mode analytics [flags]
```
