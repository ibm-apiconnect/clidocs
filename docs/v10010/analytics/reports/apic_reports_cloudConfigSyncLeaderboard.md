...
- "scope: cloud"
---
# apic reports:cloudConfigSyncLeaderboard

Config sync leaderboard

## Synopsis

Return the data needed to populate the config sync leaderboard at cloud scope.

```
apic reports:cloudConfigSyncLeaderboard --mode analytics [flags]
```
