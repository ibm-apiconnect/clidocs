...
- "scope: catalog"
---
# apic reports:catalogGatewayServicesLeaderboard

Gateway services leaderboard

## Synopsis

Return the data needed to populate the gateway services leaderboard at catalog scope.

```
apic reports:catalogGatewayServicesLeaderboard --mode analytics [flags]
```
