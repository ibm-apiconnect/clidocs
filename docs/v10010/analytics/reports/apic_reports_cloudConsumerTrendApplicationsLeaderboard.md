...
Return the data for the application leaderboard in the consumer trend report, including top_data and bottom_data along with other metrics over time at cloud scope.

```
apic reports:cloudConsumerTrendApplicationsLeaderboard --mode analytics [flags]
```
