...
```
apic destinations:cloudUpdate --mode engagement [flags]
```

## Possible Usages

```
apic destinations:cloudUpdate --mode engagement [flags] ID DESTINATION_FILE
```
