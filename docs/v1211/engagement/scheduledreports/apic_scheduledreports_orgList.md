...
- "scope: org"
---
# apic scheduledreports:orgList

List scheduled reports at provider organization scope

## Synopsis

Return a result set of scheduled reports.

```
apic scheduledreports:orgList --mode engagement [flags]
```
