...
- "scope: org"
---
# apic scheduledreports:orgUpdate

Update a scheduled report

## Synopsis

Updates a single scheduled report.

```
apic scheduledreports:orgUpdate --mode engagement [flags]
```

## Possible Usages

```
apic scheduledreports:orgUpdate --mode engagement [flags] ID SCHEDULED_REPORT_FILE
```
