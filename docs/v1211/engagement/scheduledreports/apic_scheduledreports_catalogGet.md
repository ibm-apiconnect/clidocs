...
- "scope: catalog"
---
# apic scheduledreports:catalogGet

Get a scheduled report

## Synopsis

Returns a single scheduled report.

```
apic scheduledreports:catalogGet --mode engagement [flags]
```

## Possible Usages

```
apic scheduledreports:catalogGet --mode engagement [flags] ID
```
