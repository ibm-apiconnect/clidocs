...
Get the data needed to populate the AI LLM dashboard at provider organization scope

## Synopsis

Return the data needed to populate the AI LLM dashboard at provider organization scope.
