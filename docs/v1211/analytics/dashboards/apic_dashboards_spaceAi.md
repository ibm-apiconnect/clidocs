...
- "scope: space"
---
# apic dashboards:spaceAi

Get the data needed to populate the AI LLM dashboard at space scope

## Synopsis

Return the data needed to populate the AI LLM dashboard at space scope.
