...
- "scope: cloud"
---
# apic dashboards:cloudMcp

Get the data needed to populate the MCP dashboard at cloud scope

## Synopsis

Return the data needed to populate the MCP (Model Context Protocol) dashboard at cloud scope.

```
apic dashboards:cloudMcp --mode analytics [flags]
```
