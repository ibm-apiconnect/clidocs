...
- "scope: catalog"
---
# apic dashboards:catalogMcp

Get the data needed to populate the MCP dashboard at catalog scope

## Synopsis

Return the data needed to populate the MCP (Model Context Protocol) dashboard at catalog scope.

```
apic dashboards:catalogMcp --mode analytics [flags]
```
