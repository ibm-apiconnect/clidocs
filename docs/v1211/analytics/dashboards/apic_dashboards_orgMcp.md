...
- "scope: org"
---
# apic dashboards:orgMcp

Get the data needed to populate the MCP dashboard at org scope

## Synopsis

Return the data needed to populate the MCP (Model Context Protocol) dashboard at org scope.

```
apic dashboards:orgMcp --mode analytics [flags]
```
