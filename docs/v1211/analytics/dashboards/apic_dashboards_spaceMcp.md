...
- "scope: space"
---
# apic dashboards:spaceMcp

Get the data needed to populate the MCP dashboard at space scope

## Synopsis

Return the data needed to populate the MCP (Model Context Protocol) dashboard at space scope.

```
apic dashboards:spaceMcp --mode analytics [flags]
```
