...
Return the data for the application leaderboard in the consumer trend report, including API call counts and other metrics over time at the space scope.

```
apic reports:spaceApplicationDetail --mode analytics [flags]
```
