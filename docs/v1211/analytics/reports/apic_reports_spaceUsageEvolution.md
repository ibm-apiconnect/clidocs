...
- "scope: space"
---
# apic reports:spaceUsageEvolution

Usage Evolution report

## Synopsis

Return the data needed to populate the Usage Evolution report at space scope.

```
apic reports:spaceUsageEvolution --mode analytics [flags]
```
