...
- "scope: org"
---
# apic reports:orgAiplatformconsumersLeaderboard

AI platform consumers leaderboard

## Synopsis

Return the data needed to populate the AI platform consumers leaderboard at org scope.

```
apic reports:orgAiplatformconsumersLeaderboard --mode analytics [flags]
```
