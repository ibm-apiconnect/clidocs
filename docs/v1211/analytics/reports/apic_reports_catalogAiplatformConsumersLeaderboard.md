...
- "scope: catalog"
---
# apic reports:catalogAiplatformconsumersLeaderboard

AI platform consumers leaderboard

## Synopsis

Return the data needed to populate the AI platform consumers leaderboard at catalog scope.

```
apic reports:catalogAiplatformconsumersLeaderboard --mode analytics [flags]
```
