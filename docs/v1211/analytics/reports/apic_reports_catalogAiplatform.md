...
- "scope: catalog"
---
# apic reports:catalogAiplatform

AI Platform report

## Synopsis

Return the data needed to populate the AI Platform report at catalog scope.

```
apic reports:catalogAiplatform --mode analytics [flags]
```
