...
- "scope: space"
---
# apic reports:spaceMCPServerDetail

MCP Server detail report

## Synopsis

Return the data needed to populate an MCP server for the leaderboard for the AI Platform report at space scope.

```
apic reports:spaceMCPServerDetail --mode analytics [flags]
```
