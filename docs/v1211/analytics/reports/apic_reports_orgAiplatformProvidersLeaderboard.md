...
- "scope: org"
---
# apic reports:orgAiplatformprovidersLeaderboard

AI platform providers leaderboard

## Synopsis

Return the data needed to populate the AI platform providers leaderboard at org scope.

```
apic reports:orgAiplatformprovidersLeaderboard --mode analytics [flags]
```
