...
- "scope: space"
---
# apic reports:spaceGatewayServiceDetail

Gateway service detail report

## Synopsis

Return the data needed to populate the gateway service leaderboard detail report at space scope.

```
apic reports:spaceGatewayServiceDetail --mode analytics [flags]
```

## Possible Usages

```
apic reports:spaceGatewayServiceDetail --mode analytics [flags] GATEWAY_SERVICE_NAME
```
