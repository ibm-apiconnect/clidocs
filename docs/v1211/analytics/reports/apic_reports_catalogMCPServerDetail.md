...
- "scope: catalog"
---
# apic reports:catalogMCPServerDetail

MCP Server detail report

## Synopsis

Return the data needed to populate an MCP server for the leaderboard for the AI Platform report at catalog scope.

```
apic reports:catalogMCPServerDetail --mode analytics [flags]
```
...
```
  ...
  -c, --catalog string             Catalog name or ID. (required)
      ...
      --mcpserverref string        MCP Server reference (name:version) (required)
