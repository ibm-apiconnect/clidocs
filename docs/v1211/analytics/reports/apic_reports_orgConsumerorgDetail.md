...
- "scope: org"
---
# apic reports:orgConsumerorgDetail

Consumer org detail report

## Synopsis

Return the data for the consumerorg leaderboard in the consumer trend report, including API call counts and other metrics over time at org scope.

```
apic reports:orgConsumerorgDetail --mode analytics [flags]
```

## Possible Usages

```
apic reports:orgConsumerorgDetail --mode analytics [flags] CONSUMER_ORG_NAME
```
