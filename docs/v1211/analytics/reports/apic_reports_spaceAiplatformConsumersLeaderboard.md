...
- "scope: space"
---
# apic reports:spaceAiplatformconsumersLeaderboard

AI platform consumers leaderboard

## Synopsis

Return the data needed to populate the AI platform consumers leaderboard at space scope.

```
apic reports:spaceAiplatformconsumersLeaderboard --mode analytics [flags]
```
