...
- "scope: cloud"
---
# apic reports:cloudAiplatformconsumersLeaderboard

AI platform consumers leaderboard

## Synopsis

Return the data needed to populate the AI platform consumers leaderboard at cloud scope.

```
apic reports:cloudAiplatformconsumersLeaderboard --mode analytics [flags]
```
