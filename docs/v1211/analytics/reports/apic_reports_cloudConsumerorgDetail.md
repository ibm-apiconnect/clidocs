...
Return the data for the consumerorg leaderboard in the consumer trend report, including API call counts and other metrics over time at cloud scope.

```
apic reports:cloudConsumerorgDetail --mode analytics [flags]
```

## Possible Usages

```
apic reports:cloudConsumerorgDetail --mode analytics [flags] CONSUMER_ORG_NAME
```
