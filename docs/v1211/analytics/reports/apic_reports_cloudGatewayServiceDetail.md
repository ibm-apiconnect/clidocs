...
- "scope: cloud"
---
# apic reports:cloudGatewayServiceDetail

Gateway service detail report

## Synopsis

Return the data needed to populate the gateway service leaderboard detail report at cloud scope.

```
apic reports:cloudGatewayServiceDetail --mode analytics [flags]
```

## Possible Usages

```
apic reports:cloudGatewayServiceDetail --mode analytics [flags] GATEWAY_SERVICE_NAME
```
