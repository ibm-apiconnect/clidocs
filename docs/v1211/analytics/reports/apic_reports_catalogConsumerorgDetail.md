...
Return the data for the consumerorg leaderboard in the consumer trend report, including API call counts and other metrics over time at the catalog scope.

```
apic reports:catalogConsumerorgDetail --mode analytics [flags]
```

## Possible Usages

```
apic reports:catalogConsumerorgDetail --mode analytics [flags] CONSUMER_ORG_NAME
```
