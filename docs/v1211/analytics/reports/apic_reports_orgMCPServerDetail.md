...
- "scope: org"
---
# apic reports:orgMCPServerDetail

MCP Server detail report

## Synopsis

Return the data needed to populate an MCP server for the leaderboard for the AI Platform report at org scope.

```
apic reports:orgMCPServerDetail --mode analytics [flags]
```
