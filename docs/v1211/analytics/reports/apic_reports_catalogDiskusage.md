...
- "scope: catalog"
---
# apic reports:catalogDiskusage

Disk Usage report

## Synopsis

Return the data needed to populate the Disk Usage report at catalog scope.

```
apic reports:catalogDiskusage --mode analytics [flags]
```
...
```
  ...
  -o, --org string                    Provider organization name or ID. (required)
      ...
      --report-type string            Type of entity for disk usage report (required)
