...
- "scope: cloud"
---
# apic reports:cloudAiplatformprovidersLeaderboard

AI platform providers leaderboard

## Synopsis

Return the data needed to populate the AI platform providers leaderboard at cloud scope.

```
apic reports:cloudAiplatformprovidersLeaderboard --mode analytics [flags]
```
