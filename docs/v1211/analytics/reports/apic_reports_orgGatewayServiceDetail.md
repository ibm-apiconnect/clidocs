...
- "scope: org"
---
# apic reports:orgGatewayServiceDetail

Gateway service detail report

## Synopsis

Return the data needed to populate the gateway service leaderboard detail report at org scope.

```
apic reports:orgGatewayServiceDetail --mode analytics [flags]
```

## Possible Usages

```
apic reports:orgGatewayServiceDetail --mode analytics [flags] GATEWAY_SERVICE_NAME
```
