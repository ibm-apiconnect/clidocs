...
- "scope: cloud"
---
# apic reports:cloudUsageEvolution

Usage Evolution report

## Synopsis

Return the data needed to populate the Usage Evolution report at cloud scope.

```
apic reports:cloudUsageEvolution --mode analytics [flags]
```
