...
- "scope: cloud"
---
# apic reports:cloudMCPServerDetail

MCP Server detail report

## Synopsis

Return the data needed to populate an MCP server for the leaderboard for the AI Platform report at cloud scope.

```
apic reports:cloudMCPServerDetail --mode analytics [flags]
```
