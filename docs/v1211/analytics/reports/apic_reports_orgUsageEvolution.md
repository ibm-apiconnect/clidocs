...
- "scope: org"
---
# apic reports:orgUsageEvolution

Usage Evolution report

## Synopsis

Return the data needed to populate the Usage Evolution report at org scope.

```
apic reports:orgUsageEvolution --mode analytics [flags]
```
