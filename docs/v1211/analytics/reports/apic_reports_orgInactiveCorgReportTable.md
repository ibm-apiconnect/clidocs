...
Return the data needed to populate the Inactive consumer organizations report table at org scope.
...
```
apic reports:orgInactiveCorgReportTable --mode analytics [flags]
```
