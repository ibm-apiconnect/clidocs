...
- "scope: catalog"
---
# apic listattributes:catalogConsumerorgList

Get the list of consumer organizations and their count at catalog scope

## Synopsis

Return the list of consumer organizations and their count at catalog scope.

```
apic listattributes:catalogConsumerorgList --mode analytics [flags]
```
