...
- "scope: org"
---
# apic listattributes:orgApplicationList

Get the list of applications and their count at org scope.

## Synopsis

Return the list of applications and their count at org scope.

```
apic listattributes:orgApplicationList --mode analytics [flags]
```
