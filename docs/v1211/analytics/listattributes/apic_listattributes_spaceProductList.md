...
- "scope: space"
---
# apic listattributes:spaceProductList

Get the list of products and their count at space scope.

## Synopsis

Return the list of products and their count at space scope.

```
apic listattributes:spaceProductList --mode analytics [flags]
```
