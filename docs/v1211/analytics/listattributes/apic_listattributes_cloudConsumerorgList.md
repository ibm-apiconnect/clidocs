...
- "scope: cloud"
---
# apic listattributes:cloudConsumerorgList

Get the list of consumer organizations and their count at cloud scope

## Synopsis

Return the list of consumer organizations and their count at cloud scope.

```
apic listattributes:cloudConsumerorgList --mode analytics [flags]
```
