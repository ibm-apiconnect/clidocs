...
- "scope: cloud"
---
# apic listattributes:cloudProductList

Get the list of products and their count at cloud scope.

## Synopsis

Return the list of products and their count at cloud scope.

```
apic listattributes:cloudProductList --mode analytics [flags]
```
