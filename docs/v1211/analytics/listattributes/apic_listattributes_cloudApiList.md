...
- "scope: cloud"
---
# apic listattributes:cloudApiList

Get the list of APIs and their count at cloud scope

## Synopsis

Return the list of APIs and their count at cloud scope.

```
apic listattributes:cloudApiList --mode analytics [flags]
```
