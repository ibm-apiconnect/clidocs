...
- "scope: org"
---
# apic listattributes:orgPlanList

Get the list of plans and their count at org scope.

## Synopsis

Return the list of plans and their count at org scope.

```
apic listattributes:orgPlanList --mode analytics [flags]
```
