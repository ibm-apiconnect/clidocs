...
- "scope: org"
---
# apic listattributes:orgApiList

Get the list of APIs and their count at org scope

## Synopsis

Return the list of APIs and their count at org scope.

```
apic listattributes:orgApiList --mode analytics [flags]
```
