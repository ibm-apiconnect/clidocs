...
- "scope: org"
---
# apic listattributes:spaceConsumerorgList

Get the list of consumer organizations and their count at space scope

## Synopsis

Return the list of consumer organizations and their count at space scope.

```
apic listattributes:spaceConsumerorgList --mode analytics [flags]
```
