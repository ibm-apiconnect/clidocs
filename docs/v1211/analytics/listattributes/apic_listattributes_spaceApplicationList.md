...
- "scope: space"
---
# apic listattributes:spaceApplicationList

Get the list of applications and their count at space scope.

## Synopsis

Return the list of applications and their count at space scope.

```
apic listattributes:spaceApplicationList --mode analytics [flags]
```
