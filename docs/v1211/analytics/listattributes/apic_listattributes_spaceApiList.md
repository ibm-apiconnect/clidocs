...
- "scope: space"
---
# apic listattributes:spaceApiList

Get the list of APIs and their count at space scope

## Synopsis

Return the list of APIs and their count at space scope.

```
apic listattributes:spaceApiList --mode analytics [flags]
```
