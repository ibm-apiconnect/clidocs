...
- "scope: org"
---
# apic listattributes:orgConsumerorgList

Get the list of consumer organizations and their count at org scope

## Synopsis

Return the list of consumer organizations and their count at org scope.

```
apic listattributes:orgConsumerorgList --mode analytics [flags]
```
