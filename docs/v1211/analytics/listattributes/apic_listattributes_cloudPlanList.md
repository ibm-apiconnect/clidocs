...
- "scope: cloud"
---
# apic listattributes:cloudPlanList

Get the list of plans and their count at cloud scope.

## Synopsis

Return the list of plans and their count at cloud scope.

```
apic listattributes:cloudPlanList --mode analytics [flags]
```
