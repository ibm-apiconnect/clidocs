...
- "scope: cloud"
---
# apic listattributes:cloudApplicationList

Get the list of applications and their count at cloud scope.

## Synopsis

Return the list of applications and their count at cloud scope.

```
apic listattributes:cloudApplicationList --mode analytics [flags]
```
