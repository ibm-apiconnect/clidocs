...
- "scope: org"
---
# apic listattributes:orgProductList

Get the list of products and their count at org scope.

## Synopsis

Return the list of products and their count at org scope.

```
apic listattributes:orgProductList --mode analytics [flags]
```
