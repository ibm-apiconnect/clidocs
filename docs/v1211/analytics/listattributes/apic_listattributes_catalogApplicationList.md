...
- "scope: catalog"
---
# apic listattributes:catalogApplicationList

Get the list of applications and their count at catalog scope.

## Synopsis

Return the list of applications and their count at catalog scope.

```
apic listattributes:catalogApplicationList --mode analytics [flags]
```
