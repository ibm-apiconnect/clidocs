...
- "scope: catalog"
---
# apic listattributes:catalogProductList

Get the list of products and their count at catalog scope.

## Synopsis

Return the list of products and their count at catalog scope.

```
apic listattributes:catalogProductList --mode analytics [flags]
```
