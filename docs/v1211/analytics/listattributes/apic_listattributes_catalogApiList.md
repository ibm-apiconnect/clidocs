...
- "scope: catalog"
---
# apic listattributes:catalogApiList

Get the list of APIs and their count at catalog scope

## Synopsis

Return the list of APIs and their count at catalog scope.

```
apic listattributes:catalogApiList --mode analytics [flags]
```
