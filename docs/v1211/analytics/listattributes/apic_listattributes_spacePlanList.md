...
- "scope: space"
---
# apic listattributes:spacePlanList

Get the list of plans and their count at space scope.

## Synopsis

Return the list of plans and their count at space scope.

```
apic listattributes:spacePlanList --mode analytics [flags]
```
