...
- "scope: catalog"
---
# apic listattributes:catalogPlanList

Get the list of plans and their count at catalog scope.

## Synopsis

Return the list of plans and their count at catalog scope..

```
apic listattributes:catalogPlanList --mode analytics [flags]
```
