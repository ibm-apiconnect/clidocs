...
- "scope: cloud"
---
# apic queries:cloudListCurrentDefault

List current default query at cloud scope

## Synopsis

Returns the current default query shared by others at cloud scope.

```
apic queries:cloudListCurrentDefault --mode analytics [flags]
```
