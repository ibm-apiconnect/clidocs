...
- "scope: catalog"
---
# apic summary:catalogList

List summary events at catalog scope

## Synopsis

Returns a result set of analytics summary events scoped to the catalog. The items in the result set are determined by the passed in request query to this API. The order of the result set is sorted from newest to oldest events by specified 'datetime'.

```
apic summary:catalogList --mode analytics [flags]
```
