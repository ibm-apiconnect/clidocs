...
- "scope: org"
---
# apic summary:orgList

List summary events at provider organization scope

## Synopsis

Returns a result set of analytics summary events scoped to the organization. The items in the result set are determined by the passed in request query to this API. The order of the result set is sorted from newest to oldest events by specified 'datetime'.

```
apic summary:orgList --mode analytics [flags]
```
