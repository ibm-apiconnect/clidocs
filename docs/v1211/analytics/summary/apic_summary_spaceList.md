...
- "scope: space"
---
# apic summary:spaceList

List summary events at space scope

## Synopsis

Returns a result set of analytics summary events scoped to the space. The items in the result set are determined by the passed in request query to this API. The order of the result set is sorted from newest to oldest events by specified 'datetime'.

```
apic summary:spaceList --mode analytics [flags]
```
