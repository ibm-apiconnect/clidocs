...
- "scope: cloud"
---
# apic summary:cloudCount

Count API calls for summary events at cloud scope

## Synopsis

Return the count of total API calls in analytics summary events scoped to the cloud that match the passed in request query.

```
apic summary:cloudCount --mode analytics [flags]
```
