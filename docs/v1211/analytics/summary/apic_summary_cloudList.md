...
- "scope: cloud"
---
# apic summary:cloudList

List summary events at cloud scope

## Synopsis

Returns a result set of analytics summary events scoped to the cloud. The items in the result set are determined by the passed in request query to this API. The order of the result set is sorted from newest to oldest events by specified 'datetime'.

```
apic summary:cloudList --mode analytics [flags]
```
