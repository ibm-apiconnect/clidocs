...
- "scope: catalog"
---
# apic summary:catalogCount

Count API calls for summary events at catalog scope

## Synopsis

Return the count of total API calls in analytics summary events scoped to the catalog that match the passed in request query.

```
apic summary:catalogCount --mode analytics [flags]
```
