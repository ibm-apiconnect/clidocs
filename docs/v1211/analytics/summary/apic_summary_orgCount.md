...
- "scope: org"
---
# apic summary:orgCount

Count API calls for summary events at org scope

## Synopsis

Return the count of total API calls in analytics summary events scoped to the organization that match the passed in request query.

```
apic summary:orgCount --mode analytics [flags]
```
