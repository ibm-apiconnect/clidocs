...
- "scope: org"
---
# apic gateway-scans:list

Gateway Scans list operations
...
```
apic gateway-scans:list --mode governance [flags]
```

## Possible Usages

```
apic gateway-scans:list --mode governance [flags] --scope org
```
...
```
  ...
  -h, --help                Help for gateway-scans:list
