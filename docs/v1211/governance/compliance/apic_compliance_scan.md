...
```
apic compliance:scan --mode governance [flags] --scope space COMPLIANCE_REQUEST_FILE
apic compliance:scan --mode governance [flags] --scope org COMPLIANCE_REQUEST_FILE
apic compliance:scan --mode governance [flags] --scope catalog COMPLIANCE_REQUEST_FILE
```
