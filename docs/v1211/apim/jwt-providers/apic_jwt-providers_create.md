...
- "group: jwt-providers"
---
# apic jwt-providers:create

Create a Jwt Provider object
...
```
apic jwt-providers:create [flags]
```

## Possible Usages

```
apic jwt-providers:create [flags] JWT_PROVIDER_FILE
```

## Request examples

------------------------------------
#### Example for JWT provider create
------------------------------------
