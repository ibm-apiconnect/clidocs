...
```
apic analytics-services:update [flags] --scope space ANALYTICS_SERVICE ANALYTICS_SERVICE_FILE
apic analytics-services:update [flags] --scope catalog ANALYTICS_SERVICE ANALYTICS_SERVICE_FILE
