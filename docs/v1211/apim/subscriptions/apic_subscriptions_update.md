...
```
apic subscriptions:update [flags] --scope app --space-initiated SUBSCRIPTION SUBSCRIPTION_FILE
apic subscriptions:update [flags] --space-initiated SUBSCRIPTION SUBSCRIPTION_FILE
apic subscriptions:update [flags] --scope app SUBSCRIPTION SUBSCRIPTION_FILE
