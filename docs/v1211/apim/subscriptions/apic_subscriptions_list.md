...
```
apic subscriptions:list [flags] --scope app --space-initiated
...
apic subscriptions:list [flags] --scope app
apic subscriptions:list [flags]
```
...
```
  ...
  -c, --catalog string             Catalog name or id (required)
      ...
      --mcp_server_subscriptions   Only retrieve subscriptions for MCP Servers
