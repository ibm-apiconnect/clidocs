...
- "scope: space"
---
# apic dashboards:spaceConsumer

Get the data needed to populate the Consumer dashboard at space scope

## Synopsis

Return the data needed to populate the Consumer dashboard at space scope.
