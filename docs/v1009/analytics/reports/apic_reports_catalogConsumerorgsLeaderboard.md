...
Return the data needed to populate the Consumer Organization leaderboard at catalog scope.

```
apic reports:catalogConsumerorgsLeaderboard --mode analytics [flags]
```
