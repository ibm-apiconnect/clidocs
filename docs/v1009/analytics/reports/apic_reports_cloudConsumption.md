...
- "scope: cloud"
---
# apic reports:cloudConsumption

Consumption report

## Synopsis

Return the data needed to populate the Consumption report at cloud scope.

```
apic reports:cloudConsumption --mode analytics [flags]
```
