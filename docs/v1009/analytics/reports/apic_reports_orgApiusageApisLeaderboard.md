...
Return the data needed to populate the API leaderboard for the API usage report at org scope.

```
apic reports:orgApiusageApisLeaderboard --mode analytics [flags]
```
