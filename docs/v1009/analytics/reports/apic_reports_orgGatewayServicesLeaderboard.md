...
- "scope: org"
---
# apic reports:orgGatewayServicesLeaderboard

Gateway services leaderboard

## Synopsis

Return the data needed to populate the gateway services leaderboard at org scope.

```
apic reports:orgGatewayServicesLeaderboard --mode analytics [flags]
```
