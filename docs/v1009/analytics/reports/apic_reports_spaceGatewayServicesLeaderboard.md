...
- "scope: space"
---
# apic reports:spaceGatewayServicesLeaderboard

Gateway services leaderboard

## Synopsis

Return the data needed to populate the gateway services leaderboard at space scope.

```
apic reports:spaceGatewayServicesLeaderboard --mode analytics [flags]
```
